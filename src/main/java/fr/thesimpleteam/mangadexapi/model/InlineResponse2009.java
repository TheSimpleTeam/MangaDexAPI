...
public class InlineResponse2009 {
  ...
  private List<UploadSessionFile> data = null;


  public InlineResponse2009 result(ResultEnum result) {
  ...
  **/
  ...
  public InlineResponse2009 data(List<UploadSessionFile> data) {
    
    this.data = data;
    return this;
  }

  public InlineResponse2009 addDataItem(UploadSessionFile dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<UploadSessionFile>();
    }
  ...
  **/
  ...
  public List<UploadSessionFile> getData() {
    return data;
  }


  public void setData(List<UploadSessionFile> data) {
    this.data = data;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(result, errors, data);
  }
