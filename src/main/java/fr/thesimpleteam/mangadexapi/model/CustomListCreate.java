...
public class CustomListCreate {
  ...
  public CustomListCreate name(String name) {
  ...
  **/
  ...
  public CustomListCreate visibility(VisibilityEnum visibility) {
  ...
  **/
  ...
  public CustomListCreate manga(List<UUID> manga) {
    
    this.manga = manga;
    return this;
  }

  public CustomListCreate addMangaItem(UUID mangaItem) {
    if (this.manga == null) {
      this.manga = new ArrayList<UUID>();
    }
  ...
  **/
  ...
  public List<UUID> getManga() {
    return manga;
  }


  public void setManga(List<UUID> manga) {
    this.manga = manga;
  }


  public CustomListCreate version(Integer version) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomListCreate customListCreate = (CustomListCreate) o;
    return Objects.equals(this.name, customListCreate.name) &&
        Objects.equals(this.visibility, customListCreate.visibility) &&
        Objects.equals(this.manga, customListCreate.manga) &&
        Objects.equals(this.version, customListCreate.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, visibility, manga, version);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomListCreate {\n");
