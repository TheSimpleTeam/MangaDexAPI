...
public class CustomListAttributes {
  ...
  public CustomListAttributes name(String name) {
  ...
  **/
  ...
  public CustomListAttributes visibility(VisibilityEnum visibility) {
  ...
  **/
  ...
  public CustomListAttributes version(Integer version) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomListAttributes customListAttributes = (CustomListAttributes) o;
    return Objects.equals(this.name, customListAttributes.name) &&
        Objects.equals(this.visibility, customListAttributes.visibility) &&
        Objects.equals(this.version, customListAttributes.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, visibility, version);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomListAttributes {\n");
