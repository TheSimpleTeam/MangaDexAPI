...
public class ScanlationGroupResponse {
  ...
  private ScanlationGroup data;


  public ScanlationGroupResponse result(ResultEnum result) {
  ...
  **/
  ...
  public ScanlationGroupResponse response(String response) {
  ...
  **/
  ...
  public ScanlationGroupResponse data(ScanlationGroup data) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ScanlationGroupResponse scanlationGroupResponse = (ScanlationGroupResponse) o;
    return Objects.equals(this.result, scanlationGroupResponse.result) &&
        Objects.equals(this.response, scanlationGroupResponse.response) &&
        Objects.equals(this.data, scanlationGroupResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScanlationGroupResponse {\n");
