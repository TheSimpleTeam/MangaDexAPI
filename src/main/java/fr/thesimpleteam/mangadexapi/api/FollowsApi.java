...
public class FollowsApi {
    ...
    /**
     * Build call for getUserFollowsGroup
     ...
     */
    public okhttp3.Call getUserFollowsGroupCall(Integer limit, Integer offset, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/user/follows/group";
    ...
    private okhttp3.Call getUserFollowsGroupValidateBeforeCall(Integer limit, Integer offset, List<String> includes, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getUserFollowsGroupCall(limit, offset, includes, _callback);
        return localVarCall;
     ...
     */
    public ScanlationGroupList getUserFollowsGroup(Integer limit, Integer offset, List<String> includes) throws ApiException {
        ApiResponse<ScanlationGroupList> localVarResp = getUserFollowsGroupWithHttpInfo(limit, offset, includes);
     ...
     */
    public ApiResponse<ScanlationGroupList> getUserFollowsGroupWithHttpInfo(Integer limit, Integer offset, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getUserFollowsGroupValidateBeforeCall(limit, offset, includes, null);
        Type localVarReturnType = new TypeToken<ScanlationGroupList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get logged User followed Groups (asynchronously)
     * 
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param includes  (optional)
     ...
     */
    public okhttp3.Call getUserFollowsGroupAsync(Integer limit, Integer offset, List<String> includes, final ApiCallback<ScanlationGroupList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserFollowsGroupValidateBeforeCall(limit, offset, includes, _callback);
        Type localVarReturnType = new TypeToken<ScanlationGroupList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getUserFollowsGroupId
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The User follow that Group </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The User doesn&#39;t follow that Group </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getUserFollowsGroupIdCall(UUID id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/user/follows/group/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserFollowsGroupIdValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getUserFollowsGroupId(Async)");
        }
        

        okhttp3.Call localVarCall = getUserFollowsGroupIdCall(id, _callback);
        return localVarCall;
     ...
     */
    public Response getUserFollowsGroupId(UUID id) throws ApiException {
        ApiResponse<Response> localVarResp = getUserFollowsGroupIdWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Response> getUserFollowsGroupIdWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = getUserFollowsGroupIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Check if logged User follows a Group (asynchronously)
     * 
     * @param id Scanlation Group id (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getUserFollowsGroupIdAsync(UUID id, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserFollowsGroupIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getUserFollowsGroupId_0
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The User follow that User </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The User doesn&#39;t follow that User </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getUserFollowsGroupId_0Call(UUID id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/user/follows/user/{id}"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserFollowsGroupId_0ValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getUserFollowsGroupId_0(Async)");
        }
        

        okhttp3.Call localVarCall = getUserFollowsGroupId_0Call(id, _callback);
        return localVarCall;
     ...
     */
    public Response getUserFollowsGroupId_0(UUID id) throws ApiException {
        ApiResponse<Response> localVarResp = getUserFollowsGroupId_0WithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Response> getUserFollowsGroupId_0WithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = getUserFollowsGroupId_0ValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Check if logged User follows a User (asynchronously)
     * 
     * @param id User id (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getUserFollowsGroupId_0Async(UUID id, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserFollowsGroupId_0ValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getUserFollowsManga
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param includes  (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getUserFollowsMangaCall(Integer limit, Integer offset, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/user/follows/manga";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserFollowsMangaValidateBeforeCall(Integer limit, Integer offset, List<String> includes, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getUserFollowsMangaCall(limit, offset, includes, _callback);
        return localVarCall;
     ...
     */
    public MangaList getUserFollowsManga(Integer limit, Integer offset, List<String> includes) throws ApiException {
        ApiResponse<MangaList> localVarResp = getUserFollowsMangaWithHttpInfo(limit, offset, includes);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MangaList> getUserFollowsMangaWithHttpInfo(Integer limit, Integer offset, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getUserFollowsMangaValidateBeforeCall(limit, offset, includes, null);
        Type localVarReturnType = new TypeToken<MangaList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get logged User followed Manga list (asynchronously)
     * 
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param includes  (optional)
     ...
     */
    public okhttp3.Call getUserFollowsMangaAsync(Integer limit, Integer offset, List<String> includes, final ApiCallback<MangaList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserFollowsMangaValidateBeforeCall(limit, offset, includes, _callback);
        Type localVarReturnType = new TypeToken<MangaList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getUserFollowsMangaId
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The User follow that Manga </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The User doesn&#39;t follow that Manga </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getUserFollowsMangaIdCall(UUID id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/user/follows/manga/{id}"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserFollowsMangaIdValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getUserFollowsMangaId(Async)");
        }
        

        okhttp3.Call localVarCall = getUserFollowsMangaIdCall(id, _callback);
        return localVarCall;
     ...
     */
    public Response getUserFollowsMangaId(UUID id) throws ApiException {
        ApiResponse<Response> localVarResp = getUserFollowsMangaIdWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Response> getUserFollowsMangaIdWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = getUserFollowsMangaIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Check if logged User follows a Manga (asynchronously)
     * 
     * @param id Manga id (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getUserFollowsMangaIdAsync(UUID id, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserFollowsMangaIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getUserFollowsUser
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call getUserFollowsUserCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/user/follows/user";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserFollowsUserValidateBeforeCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getUserFollowsUserCall(limit, offset, _callback);
        return localVarCall;
     ...
     */
    public UserList getUserFollowsUser(Integer limit, Integer offset) throws ApiException {
        ApiResponse<UserList> localVarResp = getUserFollowsUserWithHttpInfo(limit, offset);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserList> getUserFollowsUserWithHttpInfo(Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getUserFollowsUserValidateBeforeCall(limit, offset, null);
        Type localVarReturnType = new TypeToken<UserList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get logged User followed User list (asynchronously)
     * 
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getUserFollowsUserAsync(Integer limit, Integer offset, final ApiCallback<UserList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserFollowsUserValidateBeforeCall(limit, offset, _callback);
        Type localVarReturnType = new TypeToken<UserList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
