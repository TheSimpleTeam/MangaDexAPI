...
import fr.thesimpleteam.mangadexapi.model.CreateScanlationGroup;
import fr.thesimpleteam.mangadexapi.model.Response;
import fr.thesimpleteam.mangadexapi.model.ScanlationGroupEdit;
import fr.thesimpleteam.mangadexapi.model.ScanlationGroupList;
import fr.thesimpleteam.mangadexapi.model.ScanlationGroupResponse;
...
public class ScanlationGroupApi {
    private ApiClient localVarApiClient;

    public ScanlationGroupApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ScanlationGroupApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call deleteGroupIdCall(UUID id, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteGroupIdValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteGroupId(Async)");
        }
        

        okhttp3.Call localVarCall = deleteGroupIdCall(id, _callback);
        return localVarCall;
     ...
     */
    public Response deleteGroupId(UUID id) throws ApiException {
        ApiResponse<Response> localVarResp = deleteGroupIdWithHttpInfo(id);
     ...
     */
    public ApiResponse<Response> deleteGroupIdWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = deleteGroupIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete Scanlation Group (asynchronously)
     * 
     * @param id Scanlation Group ID (required)
     ...
     */
    public okhttp3.Call deleteGroupIdAsync(UUID id, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteGroupIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteGroupIdFollow
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call deleteGroupIdFollowCall(UUID id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/group/{id}/follow"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteGroupIdFollowValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteGroupIdFollow(Async)");
        }
        

        okhttp3.Call localVarCall = deleteGroupIdFollowCall(id, _callback);
        return localVarCall;
     ...
     */
    public Response deleteGroupIdFollow(UUID id) throws ApiException {
        ApiResponse<Response> localVarResp = deleteGroupIdFollowWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Response> deleteGroupIdFollowWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = deleteGroupIdFollowValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Unfollow Scanlation Group (asynchronously)
     * 
     * @param id  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteGroupIdFollowAsync(UUID id, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteGroupIdFollowValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getGroupId
     * @param id Scanlation Group ID (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> ScanlationGroup not found </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getGroupIdCall(UUID id, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGroupIdValidateBeforeCall(UUID id, List<String> includes, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getGroupId(Async)");
        }
        

        okhttp3.Call localVarCall = getGroupIdCall(id, includes, _callback);
        return localVarCall;
     ...
     */
    public ScanlationGroupResponse getGroupId(UUID id, List<String> includes) throws ApiException {
        ApiResponse<ScanlationGroupResponse> localVarResp = getGroupIdWithHttpInfo(id, includes);
        return localVarResp.getData();
    }
     ...
     * @param id Scanlation Group ID (required)
     * @param includes  (optional)
     * @return ApiResponse&lt;ScanlationGroupResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ScanlationGroupResponse> getGroupIdWithHttpInfo(UUID id, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getGroupIdValidateBeforeCall(id, includes, null);
        Type localVarReturnType = new TypeToken<ScanlationGroupResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * View Scanlation Group (asynchronously)
     * 
     * @param id Scanlation Group ID (required)
     * @param includes  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getGroupIdAsync(UUID id, List<String> includes, final ApiCallback<ScanlationGroupResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGroupIdValidateBeforeCall(id, includes, _callback);
        Type localVarReturnType = new TypeToken<ScanlationGroupResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getSearchGroup
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param ids ScanlationGroup ids (limited to 100 per request) (optional)
     * @param name  (optional)
     * @param focusedLanguage  (optional)
     * @param includes  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getSearchGroupCall(Integer limit, Integer offset, List<UUID> ids, String name, String focusedLanguage, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (focusedLanguage != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("focusedLanguage", focusedLanguage));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSearchGroupValidateBeforeCall(Integer limit, Integer offset, List<UUID> ids, String name, String focusedLanguage, List<String> includes, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getSearchGroupCall(limit, offset, ids, name, focusedLanguage, includes, _callback);
        return localVarCall;
     ...
     */
    public ScanlationGroupList getSearchGroup(Integer limit, Integer offset, List<UUID> ids, String name, String focusedLanguage, List<String> includes) throws ApiException {
        ApiResponse<ScanlationGroupList> localVarResp = getSearchGroupWithHttpInfo(limit, offset, ids, name, focusedLanguage, includes);
        return localVarResp.getData();
    }
     ...
     * @param focusedLanguage  (optional)
     * @param includes  (optional)
     * @return ApiResponse&lt;ScanlationGroupList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ScanlationGroupList> getSearchGroupWithHttpInfo(Integer limit, Integer offset, List<UUID> ids, String name, String focusedLanguage, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getSearchGroupValidateBeforeCall(limit, offset, ids, name, focusedLanguage, includes, null);
        Type localVarReturnType = new TypeToken<ScanlationGroupList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Scanlation Group list (asynchronously)
     * 
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param ids ScanlationGroup ids (limited to 100 per request) (optional)
     ...
     */
    public okhttp3.Call getSearchGroupAsync(Integer limit, Integer offset, List<UUID> ids, String name, String focusedLanguage, List<String> includes, final ApiCallback<ScanlationGroupList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSearchGroupValidateBeforeCall(limit, offset, ids, name, focusedLanguage, includes, _callback);
        Type localVarReturnType = new TypeToken<ScanlationGroupList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postGroup
     * @param contentType  (required)
     * @param createScanlationGroup The size of the body is limited to 16KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postGroupCall(String contentType, CreateScanlationGroup createScanlationGroup, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = createScanlationGroup;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postGroupValidateBeforeCall(String contentType, CreateScanlationGroup createScanlationGroup, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling postGroup(Async)");
        }
        

        okhttp3.Call localVarCall = postGroupCall(contentType, createScanlationGroup, _callback);
        return localVarCall;
     ...
     */
    public ScanlationGroupResponse postGroup(String contentType, CreateScanlationGroup createScanlationGroup) throws ApiException {
        ApiResponse<ScanlationGroupResponse> localVarResp = postGroupWithHttpInfo(contentType, createScanlationGroup);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ScanlationGroupResponse> postGroupWithHttpInfo(String contentType, CreateScanlationGroup createScanlationGroup) throws ApiException {
        okhttp3.Call localVarCall = postGroupValidateBeforeCall(contentType, createScanlationGroup, null);
        Type localVarReturnType = new TypeToken<ScanlationGroupResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create Scanlation Group (asynchronously)
     * 
     * @param contentType  (required)
     * @param createScanlationGroup The size of the body is limited to 16KB. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call postGroupAsync(String contentType, CreateScanlationGroup createScanlationGroup, final ApiCallback<ScanlationGroupResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postGroupValidateBeforeCall(contentType, createScanlationGroup, _callback);
        Type localVarReturnType = new TypeToken<ScanlationGroupResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postGroupIdFollow
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call postGroupIdFollowCall(UUID id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postGroupIdFollowValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling postGroupIdFollow(Async)");
        }
        

        okhttp3.Call localVarCall = postGroupIdFollowCall(id, _callback);
        return localVarCall;
     ...
     */
    public Response postGroupIdFollow(UUID id) throws ApiException {
        ApiResponse<Response> localVarResp = postGroupIdFollowWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Response> postGroupIdFollowWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = postGroupIdFollowValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Follow Scanlation Group (asynchronously)
     * 
     * @param id  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call postGroupIdFollowAsync(UUID id, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = postGroupIdFollowValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for putGroupId
     * @param id Scanlation Group ID (required)
     * @param contentType  (required)
     * @param scanlationGroupEdit The size of the body is limited to 8KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call putGroupIdCall(UUID id, String contentType, ScanlationGroupEdit scanlationGroupEdit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = scanlationGroupEdit;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putGroupIdValidateBeforeCall(UUID id, String contentType, ScanlationGroupEdit scanlationGroupEdit, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling putGroupId(Async)");
        }
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling putGroupId(Async)");
        }
        

        okhttp3.Call localVarCall = putGroupIdCall(id, contentType, scanlationGroupEdit, _callback);
        return localVarCall;
     ...
     */
    public ScanlationGroupResponse putGroupId(UUID id, String contentType, ScanlationGroupEdit scanlationGroupEdit) throws ApiException {
        ApiResponse<ScanlationGroupResponse> localVarResp = putGroupIdWithHttpInfo(id, contentType, scanlationGroupEdit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ScanlationGroupResponse> putGroupIdWithHttpInfo(UUID id, String contentType, ScanlationGroupEdit scanlationGroupEdit) throws ApiException {
        okhttp3.Call localVarCall = putGroupIdValidateBeforeCall(id, contentType, scanlationGroupEdit, null);
        Type localVarReturnType = new TypeToken<ScanlationGroupResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update Scanlation Group (asynchronously)
     * 
     * @param id Scanlation Group ID (required)
     * @param contentType  (required)
     * @param scanlationGroupEdit The size of the body is limited to 8KB. (optional)
     ...
     */
    public okhttp3.Call putGroupIdAsync(UUID id, String contentType, ScanlationGroupEdit scanlationGroupEdit, final ApiCallback<ScanlationGroupResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = putGroupIdValidateBeforeCall(id, contentType, scanlationGroupEdit, _callback);
        Type localVarReturnType = new TypeToken<ScanlationGroupResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
