...
public class AuthorList {
  ...
  public AuthorList result(String result) {
  ...
  **/
  ...
  public AuthorList response(String response) {
  ...
  **/
  ...
  public AuthorList data(List<Author> data) {
    
    this.data = data;
    return this;
  }

  public AuthorList addDataItem(Author dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Author>();
    }
  ...
  **/
  ...
  public AuthorList limit(Integer limit) {
  ...
  **/
  ...
  public AuthorList offset(Integer offset) {
  ...
  **/
  ...
  public AuthorList total(Integer total) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AuthorList authorList = (AuthorList) o;
    return Objects.equals(this.result, authorList.result) &&
        Objects.equals(this.response, authorList.response) &&
        Objects.equals(this.data, authorList.data) &&
        Objects.equals(this.limit, authorList.limit) &&
        Objects.equals(this.offset, authorList.offset) &&
        Objects.equals(this.total, authorList.total);
  }
