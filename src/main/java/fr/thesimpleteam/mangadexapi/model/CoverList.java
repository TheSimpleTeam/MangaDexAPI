...
public class CoverList {
  ...
  public CoverList result(String result) {
  ...
  **/
  ...
  public CoverList response(String response) {
  ...
  **/
  ...
  public CoverList data(List<Cover> data) {
    
    this.data = data;
    return this;
  }

  public CoverList addDataItem(Cover dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Cover>();
    }
  ...
  **/
  ...
  public void setData(List<Cover> data) {
    this.data = data;
  }


  public CoverList limit(Integer limit) {
  ...
  **/
  ...
  public CoverList offset(Integer offset) {
  ...
  **/
  ...
  public CoverList total(Integer total) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CoverList coverList = (CoverList) o;
    return Objects.equals(this.result, coverList.result) &&
        Objects.equals(this.response, coverList.response) &&
        Objects.equals(this.data, coverList.data) &&
        Objects.equals(this.limit, coverList.limit) &&
        Objects.equals(this.offset, coverList.offset) &&
        Objects.equals(this.total, coverList.total);
  }
