...
public class ChapterEdit {
  ...
  public ChapterEdit title(String title) {
  ...
  **/
  ...
  public ChapterEdit volume(String volume) {
  ...
  **/
  ...
  public ChapterEdit chapter(String chapter) {
  ...
  **/
  ...
  public ChapterEdit translatedLanguage(String translatedLanguage) {
  ...
  **/
  ...
  public ChapterEdit groups(List<UUID> groups) {
    
    this.groups = groups;
    return this;
  }

  public ChapterEdit addGroupsItem(UUID groupsItem) {
    if (this.groups == null) {
  ...
  **/
  ...
  public ChapterEdit version(Integer version) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChapterEdit chapterEdit = (ChapterEdit) o;
    return Objects.equals(this.title, chapterEdit.title) &&
        Objects.equals(this.volume, chapterEdit.volume) &&
        Objects.equals(this.chapter, chapterEdit.chapter) &&
        Objects.equals(this.translatedLanguage, chapterEdit.translatedLanguage) &&
        Objects.equals(this.groups, chapterEdit.groups) &&
        Objects.equals(this.version, chapterEdit.version);
  }
