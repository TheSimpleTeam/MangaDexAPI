...
import fr.thesimpleteam.mangadexapi.model.InlineResponse2008;
...
import fr.thesimpleteam.mangadexapi.model.InlineObject5;
...
public class ReportApi {
    ...
    /**
     * Build call for getReportReasonsByCategory
     ...
     */
    public okhttp3.Call getReportReasonsByCategoryCall(String category, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/report/reasons/{category}"
    ...
    private okhttp3.Call getReportReasonsByCategoryValidateBeforeCall(String category, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'category' is set
        if (category == null) {
            throw new ApiException("Missing the required parameter 'category' when calling getReportReasonsByCategory(Async)");
        }
        

        okhttp3.Call localVarCall = getReportReasonsByCategoryCall(category, _callback);
        return localVarCall;
     ...
     */
    public InlineResponse2008 getReportReasonsByCategory(String category) throws ApiException {
        ApiResponse<InlineResponse2008> localVarResp = getReportReasonsByCategoryWithHttpInfo(category);
     ...
     */
    public ApiResponse<InlineResponse2008> getReportReasonsByCategoryWithHttpInfo(String category) throws ApiException {
        okhttp3.Call localVarCall = getReportReasonsByCategoryValidateBeforeCall(category, null);
        Type localVarReturnType = new TypeToken<InlineResponse2008>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a list of report reasons (asynchronously)
     * 
     * @param category  (required)
     ...
     */
    public okhttp3.Call getReportReasonsByCategoryAsync(String category, final ApiCallback<InlineResponse2008> _callback) throws ApiException {

        okhttp3.Call localVarCall = getReportReasonsByCategoryValidateBeforeCall(category, _callback);
        Type localVarReturnType = new TypeToken<InlineResponse2008>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postReport
     ...
     */
    public okhttp3.Call postReportCall(String contentType, InlineObject5 inlineObject5, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postReportValidateBeforeCall(String contentType, InlineObject5 inlineObject5, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling postReport(Async)");
        }
        

        okhttp3.Call localVarCall = postReportCall(contentType, inlineObject5, _callback);
        return localVarCall;
     ...
     */
    public Response postReport(String contentType, InlineObject5 inlineObject5) throws ApiException {
        ApiResponse<Response> localVarResp = postReportWithHttpInfo(contentType, inlineObject5);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Response> postReportWithHttpInfo(String contentType, InlineObject5 inlineObject5) throws ApiException {
        okhttp3.Call localVarCall = postReportValidateBeforeCall(contentType, inlineObject5, null);
     ...
     */
    public okhttp3.Call postReportAsync(String contentType, InlineObject5 inlineObject5, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = postReportValidateBeforeCall(contentType, inlineObject5, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
