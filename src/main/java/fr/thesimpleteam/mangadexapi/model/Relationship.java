...
public class Relationship {
   ...
   */
  @JsonAdapter(RelatedEnum.Adapter.class)
  public enum RelatedEnum {
    ...
    public static RelatedEnum fromValue(String value) {
      for (RelatedEnum b : RelatedEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<RelatedEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RelatedEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RelatedEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return RelatedEnum.fromValue(value);
      }
    }
  }
  ...
  **/
  ...
  public Relationship related(RelatedEnum related) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Related Manga type, only present if you are on a Manga entity and a Manga relationship")

  public RelatedEnum getRelated() {
    return related;
  }


  public void setRelated(RelatedEnum related) {
    this.related = related;
  }


  public Relationship attributes(Object attributes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If Reference Expansion is applied, contains objects attributes")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, relationship.id) &&
        ...
        Objects.equals(this.related, relationship.related) &&
        Objects.equals(this.attributes, relationship.attributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, related, attributes);
  }
