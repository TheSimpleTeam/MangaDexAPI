...
public class MangaRelationCreate {
  public static final String SERIALIZED_NAME_TARGET_MANGA = "targetManga";
  @SerializedName(SERIALIZED_NAME_TARGET_MANGA)
  private UUID targetManga;
  ...
  public MangaRelationCreate targetManga(UUID targetManga) {
  ...
  **/
  ...
  public UUID getTargetManga() {
    return targetManga;
  }


  public void setTargetManga(UUID targetManga) {
    this.targetManga = targetManga;
  }


  public MangaRelationCreate relation(RelationEnum relation) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MangaRelationCreate mangaRelationCreate = (MangaRelationCreate) o;
    return Objects.equals(this.targetManga, mangaRelationCreate.targetManga) &&
        Objects.equals(this.relation, mangaRelationCreate.relation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetManga, relation);
  }
  ...
  public String toString() {
    ...
    sb.append("    targetManga: ").append(toIndentedString(targetManga)).append("\n");
