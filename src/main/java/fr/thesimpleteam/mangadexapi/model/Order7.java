...
public class Order7 {
   ...
   */
  @JsonAdapter(PublishAtEnum.Adapter.class)
  public enum PublishAtEnum {
    ...
    public static PublishAtEnum fromValue(String value) {
      for (PublishAtEnum b : PublishAtEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<PublishAtEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PublishAtEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public PublishAtEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return PublishAtEnum.fromValue(value);
      }
    }
  }
  ...
  private PublishAtEnum publishAt;
  ...
  public enum VolumeEnum {
    ...
    public static class Adapter extends TypeAdapter<VolumeEnum> {
      ...
      public VolumeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return VolumeEnum.fromValue(value);
      }
    }
  }
   ...
   */
  @JsonAdapter(ChapterEnum.Adapter.class)
  public enum ChapterEnum {
    ...
    public static ChapterEnum fromValue(String value) {
      for (ChapterEnum b : ChapterEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<ChapterEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ChapterEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ChapterEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ChapterEnum.fromValue(value);
      }
    }
  }
  ...
  private ChapterEnum chapter;


  public Order7 createdAt(CreatedAtEnum createdAt) {
  ...
  **/
  ...
  public Order7 updatedAt(UpdatedAtEnum updatedAt) {
  ...
  **/
  ...
  public Order7 publishAt(PublishAtEnum publishAt) {
  ...
  **/
  ...
  public PublishAtEnum getPublishAt() {
    return publishAt;
  }


  public void setPublishAt(PublishAtEnum publishAt) {
    this.publishAt = publishAt;
  }


  public Order7 volume(VolumeEnum volume) {
  ...
  **/
  ...
  public Order7 chapter(ChapterEnum chapter) {
  ...
  **/
  ...
  public ChapterEnum getChapter() {
    return chapter;
  }


  public void setChapter(ChapterEnum chapter) {
    this.chapter = chapter;
  }
  ...
  public boolean equals(Object o) {
    ...
    Order7 order7 = (Order7) o;
    return Objects.equals(this.createdAt, order7.createdAt) &&
        Objects.equals(this.updatedAt, order7.updatedAt) &&
        Objects.equals(this.publishAt, order7.publishAt) &&
        Objects.equals(this.volume, order7.volume) &&
        Objects.equals(this.chapter, order7.chapter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, updatedAt, publishAt, volume, chapter);
  }
