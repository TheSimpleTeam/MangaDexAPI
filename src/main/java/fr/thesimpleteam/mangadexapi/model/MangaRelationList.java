...
public class MangaRelationList {
  ...
  private List<MangaRelation> data = null;
  ...
  public MangaRelationList result(String result) {
  ...
  **/
  ...
  public MangaRelationList response(String response) {
  ...
  **/
  ...
  public MangaRelationList data(List<MangaRelation> data) {
    
    this.data = data;
    return this;
  }

  public MangaRelationList addDataItem(MangaRelation dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<MangaRelation>();
    }
  ...
  **/
  ...
  public List<MangaRelation> getData() {
    return data;
  }


  public void setData(List<MangaRelation> data) {
    this.data = data;
  }


  public MangaRelationList limit(Integer limit) {
  ...
  **/
  ...
  public MangaRelationList offset(Integer offset) {
  ...
  **/
  ...
  public MangaRelationList total(Integer total) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MangaRelationList mangaRelationList = (MangaRelationList) o;
    return Objects.equals(this.result, mangaRelationList.result) &&
        Objects.equals(this.response, mangaRelationList.response) &&
        Objects.equals(this.data, mangaRelationList.data) &&
        Objects.equals(this.limit, mangaRelationList.limit) &&
        Objects.equals(this.offset, mangaRelationList.offset) &&
        Objects.equals(this.total, mangaRelationList.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class MangaRelationList {\n");
