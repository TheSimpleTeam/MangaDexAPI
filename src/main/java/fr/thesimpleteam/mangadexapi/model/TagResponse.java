...
public class TagResponse {
  ...
  public TagResponse result(String result) {
  ...
  **/
  ...
  public TagResponse response(String response) {
  ...
  **/
  ...
  public TagResponse data(List<Tag> data) {
    
    this.data = data;
    return this;
  }

  public TagResponse addDataItem(Tag dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public TagResponse limit(Integer limit) {
  ...
  **/
  ...
  public TagResponse offset(Integer offset) {
  ...
  **/
  ...
  public TagResponse total(Integer total) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.result, tagResponse.result) &&
        Objects.equals(this.response, tagResponse.response) &&
        Objects.equals(this.data, tagResponse.data) &&
        Objects.equals(this.limit, tagResponse.limit) &&
        Objects.equals(this.offset, tagResponse.offset) &&
        Objects.equals(this.total, tagResponse.total);
  }
