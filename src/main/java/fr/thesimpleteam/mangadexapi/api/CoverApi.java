...
import fr.thesimpleteam.mangadexapi.model.CoverEdit;
import fr.thesimpleteam.mangadexapi.model.CoverList;
import fr.thesimpleteam.mangadexapi.model.CoverResponse;

import java.io.File;
import fr.thesimpleteam.mangadexapi.model.Order5;
...
public class CoverApi {
    ...
    public CoverApi(ApiClient apiClient) {
    ...
    /**
     * Build call for deleteCover
     * @param coverId  (required)
     ...
     */
    public okhttp3.Call deleteCoverCall(UUID coverId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/cover/{coverId}"
            .replaceAll("\\{" + "coverId" + "\\}", localVarApiClient.escapeString(coverId.toString()));
    ...
    private okhttp3.Call deleteCoverValidateBeforeCall(UUID coverId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'coverId' is set
        if (coverId == null) {
            throw new ApiException("Missing the required parameter 'coverId' when calling deleteCover(Async)");
        }
        

        okhttp3.Call localVarCall = deleteCoverCall(coverId, _callback);
        return localVarCall;
     ...
     */
    public Response deleteCover(UUID coverId) throws ApiException {
        ApiResponse<Response> localVarResp = deleteCoverWithHttpInfo(coverId);
     ...
     */
    public ApiResponse<Response> deleteCoverWithHttpInfo(UUID coverId) throws ApiException {
        okhttp3.Call localVarCall = deleteCoverValidateBeforeCall(coverId, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete Cover (asynchronously)
     * 
     * @param coverId  (required)
     ...
     */
    public okhttp3.Call deleteCoverAsync(UUID coverId, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteCoverValidateBeforeCall(coverId, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for editCover
     * @param coverId  (required)
     * @param contentType  (required)
     * @param coverEdit The size of the body is limited to 2KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call editCoverCall(UUID coverId, String contentType, CoverEdit coverEdit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = coverEdit;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call editCoverValidateBeforeCall(UUID coverId, String contentType, CoverEdit coverEdit, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'coverId' is set
        if (coverId == null) {
            throw new ApiException("Missing the required parameter 'coverId' when calling editCover(Async)");
        }
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling editCover(Async)");
        }
        

        okhttp3.Call localVarCall = editCoverCall(coverId, contentType, coverEdit, _callback);
        return localVarCall;
     ...
     */
    public CoverResponse editCover(UUID coverId, String contentType, CoverEdit coverEdit) throws ApiException {
        ApiResponse<CoverResponse> localVarResp = editCoverWithHttpInfo(coverId, contentType, coverEdit);
        return localVarResp.getData();
    }
     ...
     * @param contentType  (required)
     * @param coverEdit The size of the body is limited to 2KB. (optional)
     * @return ApiResponse&lt;CoverResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CoverResponse> editCoverWithHttpInfo(UUID coverId, String contentType, CoverEdit coverEdit) throws ApiException {
        okhttp3.Call localVarCall = editCoverValidateBeforeCall(coverId, contentType, coverEdit, null);
        Type localVarReturnType = new TypeToken<CoverResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Edit Cover (asynchronously)
     * 
     * @param coverId  (required)
     * @param contentType  (required)
     * @param coverEdit The size of the body is limited to 2KB. (optional)
     ...
     */
    public okhttp3.Call editCoverAsync(UUID coverId, String contentType, CoverEdit coverEdit, final ApiCallback<CoverResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = editCoverValidateBeforeCall(coverId, contentType, coverEdit, _callback);
        Type localVarReturnType = new TypeToken<CoverResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getCover
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param manga Manga ids (limited to 100 per request) (optional)
     * @param ids Covers ids (limited to 100 per request) (optional)
     * @param uploaders User ids (limited to 100 per request) (optional)
     ...
     */
    public okhttp3.Call getCoverCall(Integer limit, Integer offset, List<UUID> manga, List<UUID> ids, List<UUID> uploaders, Order5 order, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/cover";
        ...
        if (manga != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "manga[]", manga));
        }
        ...
        if (uploaders != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "uploaders[]", uploaders));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCoverValidateBeforeCall(Integer limit, Integer offset, List<UUID> manga, List<UUID> ids, List<UUID> uploaders, Order5 order, List<String> includes, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getCoverCall(limit, offset, manga, ids, uploaders, order, includes, _callback);
        return localVarCall;
     ...
     */
    public CoverList getCover(Integer limit, Integer offset, List<UUID> manga, List<UUID> ids, List<UUID> uploaders, Order5 order, List<String> includes) throws ApiException {
        ApiResponse<CoverList> localVarResp = getCoverWithHttpInfo(limit, offset, manga, ids, uploaders, order, includes);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CoverList> getCoverWithHttpInfo(Integer limit, Integer offset, List<UUID> manga, List<UUID> ids, List<UUID> uploaders, Order5 order, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getCoverValidateBeforeCall(limit, offset, manga, ids, uploaders, order, includes, null);
        Type localVarReturnType = new TypeToken<CoverList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CoverArt list (asynchronously)
     * 
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param manga Manga ids (limited to 100 per request) (optional)
     ...
     */
    public okhttp3.Call getCoverAsync(Integer limit, Integer offset, List<UUID> manga, List<UUID> ids, List<UUID> uploaders, Order5 order, List<String> includes, final ApiCallback<CoverList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCoverValidateBeforeCall(limit, offset, manga, ids, uploaders, order, includes, _callback);
        Type localVarReturnType = new TypeToken<CoverList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getCoverId
     * @param coverId  (required)
     * @param includes  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Bad Request </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> CoverArt not found </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getCoverIdCall(UUID coverId, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCoverIdValidateBeforeCall(UUID coverId, List<String> includes, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'coverId' is set
        if (coverId == null) {
            throw new ApiException("Missing the required parameter 'coverId' when calling getCoverId(Async)");
        }
        

        okhttp3.Call localVarCall = getCoverIdCall(coverId, includes, _callback);
        return localVarCall;
     ...
     */
    public CoverResponse getCoverId(UUID coverId, List<String> includes) throws ApiException {
        ApiResponse<CoverResponse> localVarResp = getCoverIdWithHttpInfo(coverId, includes);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CoverResponse> getCoverIdWithHttpInfo(UUID coverId, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getCoverIdValidateBeforeCall(coverId, includes, null);
        Type localVarReturnType = new TypeToken<CoverResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getCoverIdAsync(UUID coverId, List<String> includes, final ApiCallback<CoverResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCoverIdValidateBeforeCall(coverId, includes, _callback);
        Type localVarReturnType = new TypeToken<CoverResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for uploadCover
     ...
     */
    public okhttp3.Call uploadCoverCall(UUID mangaId, String contentType, File file, String volume, String description, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/cover/{mangaId}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call uploadCoverValidateBeforeCall(UUID mangaId, String contentType, File file, String volume, String description, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'mangaId' is set
        if (mangaId == null) {
            throw new ApiException("Missing the required parameter 'mangaId' when calling uploadCover(Async)");
        }
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling uploadCover(Async)");
        }
        

        okhttp3.Call localVarCall = uploadCoverCall(mangaId, contentType, file, volume, description, _callback);
        return localVarCall;
     ...
     */
    public CoverResponse uploadCover(UUID mangaId, String contentType, File file, String volume, String description) throws ApiException {
        ApiResponse<CoverResponse> localVarResp = uploadCoverWithHttpInfo(mangaId, contentType, file, volume, description);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CoverResponse> uploadCoverWithHttpInfo(UUID mangaId, String contentType, File file, String volume, String description) throws ApiException {
        okhttp3.Call localVarCall = uploadCoverValidateBeforeCall(mangaId, contentType, file, volume, description, null);
        Type localVarReturnType = new TypeToken<CoverResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Upload Cover (asynchronously)
     * 
     * @param mangaId  (required)
     * @param contentType  (required)
     * @param file  (optional)
     ...
     */
    public okhttp3.Call uploadCoverAsync(UUID mangaId, String contentType, File file, String volume, String description, final ApiCallback<CoverResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = uploadCoverValidateBeforeCall(mangaId, contentType, file, volume, description, _callback);
        Type localVarReturnType = new TypeToken<CoverResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
