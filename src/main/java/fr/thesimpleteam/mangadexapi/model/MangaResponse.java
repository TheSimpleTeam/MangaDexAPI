...
public class MangaResponse {
  ...
  public MangaResponse result(ResultEnum result) {
  ...
  **/
  ...
  public MangaResponse response(String response) {
  ...
  **/
  ...
  public MangaResponse data(Manga data) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MangaResponse mangaResponse = (MangaResponse) o;
    return Objects.equals(this.result, mangaResponse.result) &&
        Objects.equals(this.response, mangaResponse.response) &&
        Objects.equals(this.data, mangaResponse.data);
  }
