...
import fr.thesimpleteam.mangadexapi.model.AccountActivateResponse;
import fr.thesimpleteam.mangadexapi.model.CreateAccount;
import fr.thesimpleteam.mangadexapi.model.RecoverCompleteBody;
import fr.thesimpleteam.mangadexapi.model.SendAccountActivationCode;
...
public class AccountApi {
    ...
    /**
     * Build call for getAccountActivateCode
     * @param code  (required)
     ...
     */
    public okhttp3.Call getAccountActivateCodeCall(String code, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/account/activate/{code}"
    ...
    private okhttp3.Call getAccountActivateCodeValidateBeforeCall(String code, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getAccountActivateCode(Async)");
        }
        

        okhttp3.Call localVarCall = getAccountActivateCodeCall(code, _callback);
        return localVarCall;
     ...
     */
    public AccountActivateResponse getAccountActivateCode(String code) throws ApiException {
        ApiResponse<AccountActivateResponse> localVarResp = getAccountActivateCodeWithHttpInfo(code);
     ...
     * 
     * @param code  (required)
     * @return ApiResponse&lt;AccountActivateResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AccountActivateResponse> getAccountActivateCodeWithHttpInfo(String code) throws ApiException {
        okhttp3.Call localVarCall = getAccountActivateCodeValidateBeforeCall(code, null);
        Type localVarReturnType = new TypeToken<AccountActivateResponse>(){}.getType();
     ...
     */
    public okhttp3.Call getAccountActivateCodeAsync(String code, final ApiCallback<AccountActivateResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountActivateCodeValidateBeforeCall(code, _callback);
        Type localVarReturnType = new TypeToken<AccountActivateResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postAccountActivateResend
     * @param contentType  (required)
     * @param sendAccountActivationCode The size of the body is limited to 1KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postAccountActivateResendCall(String contentType, SendAccountActivationCode sendAccountActivationCode, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = sendAccountActivationCode;

        // create path and map variables
        String localVarPath = "/account/activate/resend";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postAccountActivateResendValidateBeforeCall(String contentType, SendAccountActivationCode sendAccountActivationCode, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling postAccountActivateResend(Async)");
        }
        

        okhttp3.Call localVarCall = postAccountActivateResendCall(contentType, sendAccountActivationCode, _callback);
        return localVarCall;
     ...
     */
    public AccountActivateResponse postAccountActivateResend(String contentType, SendAccountActivationCode sendAccountActivationCode) throws ApiException {
        ApiResponse<AccountActivateResponse> localVarResp = postAccountActivateResendWithHttpInfo(contentType, sendAccountActivationCode);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AccountActivateResponse> postAccountActivateResendWithHttpInfo(String contentType, SendAccountActivationCode sendAccountActivationCode) throws ApiException {
        okhttp3.Call localVarCall = postAccountActivateResendValidateBeforeCall(contentType, sendAccountActivationCode, null);
        Type localVarReturnType = new TypeToken<AccountActivateResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Resend Activation code (asynchronously)
     * 
     * @param contentType  (required)
     * @param sendAccountActivationCode The size of the body is limited to 1KB. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call postAccountActivateResendAsync(String contentType, SendAccountActivationCode sendAccountActivationCode, final ApiCallback<AccountActivateResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postAccountActivateResendValidateBeforeCall(contentType, sendAccountActivationCode, _callback);
        Type localVarReturnType = new TypeToken<AccountActivateResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postAccountCreate
     * @param contentType  (required)
     * @param createAccount The size of the body is limited to 4KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postAccountCreateCall(String contentType, CreateAccount createAccount, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = createAccount;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postAccountCreateValidateBeforeCall(String contentType, CreateAccount createAccount, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling postAccountCreate(Async)");
        }
        

        okhttp3.Call localVarCall = postAccountCreateCall(contentType, createAccount, _callback);
        return localVarCall;
     ...
     */
    public UserResponse postAccountCreate(String contentType, CreateAccount createAccount) throws ApiException {
        ApiResponse<UserResponse> localVarResp = postAccountCreateWithHttpInfo(contentType, createAccount);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserResponse> postAccountCreateWithHttpInfo(String contentType, CreateAccount createAccount) throws ApiException {
        okhttp3.Call localVarCall = postAccountCreateValidateBeforeCall(contentType, createAccount, null);
     ...
     */
    public okhttp3.Call postAccountCreateAsync(String contentType, CreateAccount createAccount, final ApiCallback<UserResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postAccountCreateValidateBeforeCall(contentType, createAccount, _callback);
        Type localVarReturnType = new TypeToken<UserResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postAccountRecover
     * @param contentType  (required)
     * @param sendAccountActivationCode The size of the body is limited to 1KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call postAccountRecoverCall(String contentType, SendAccountActivationCode sendAccountActivationCode, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = sendAccountActivationCode;

        // create path and map variables
        String localVarPath = "/account/recover";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postAccountRecoverValidateBeforeCall(String contentType, SendAccountActivationCode sendAccountActivationCode, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling postAccountRecover(Async)");
        }
        

        okhttp3.Call localVarCall = postAccountRecoverCall(contentType, sendAccountActivationCode, _callback);
        return localVarCall;
     ...
     */
    public AccountActivateResponse postAccountRecover(String contentType, SendAccountActivationCode sendAccountActivationCode) throws ApiException {
        ApiResponse<AccountActivateResponse> localVarResp = postAccountRecoverWithHttpInfo(contentType, sendAccountActivationCode);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AccountActivateResponse> postAccountRecoverWithHttpInfo(String contentType, SendAccountActivationCode sendAccountActivationCode) throws ApiException {
        okhttp3.Call localVarCall = postAccountRecoverValidateBeforeCall(contentType, sendAccountActivationCode, null);
        Type localVarReturnType = new TypeToken<AccountActivateResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Recover given Account (asynchronously)
     * You can only request Account Recovery once per Hour for the same Email Address
     * @param contentType  (required)
     * @param sendAccountActivationCode The size of the body is limited to 1KB. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call postAccountRecoverAsync(String contentType, SendAccountActivationCode sendAccountActivationCode, final ApiCallback<AccountActivateResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postAccountRecoverValidateBeforeCall(contentType, sendAccountActivationCode, _callback);
        Type localVarReturnType = new TypeToken<AccountActivateResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postAccountRecoverCode
     * @param code  (required)
     * @param contentType  (required)
     * @param recoverCompleteBody The size of the body is limited to 2KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postAccountRecoverCodeCall(String code, String contentType, RecoverCompleteBody recoverCompleteBody, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = recoverCompleteBody;

        // create path and map variables
        String localVarPath = "/account/recover/{code}"
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postAccountRecoverCodeValidateBeforeCall(String code, String contentType, RecoverCompleteBody recoverCompleteBody, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling postAccountRecoverCode(Async)");
        }
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling postAccountRecoverCode(Async)");
        }
        

        okhttp3.Call localVarCall = postAccountRecoverCodeCall(code, contentType, recoverCompleteBody, _callback);
        return localVarCall;
     ...
     */
    public AccountActivateResponse postAccountRecoverCode(String code, String contentType, RecoverCompleteBody recoverCompleteBody) throws ApiException {
        ApiResponse<AccountActivateResponse> localVarResp = postAccountRecoverCodeWithHttpInfo(code, contentType, recoverCompleteBody);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AccountActivateResponse> postAccountRecoverCodeWithHttpInfo(String code, String contentType, RecoverCompleteBody recoverCompleteBody) throws ApiException {
        okhttp3.Call localVarCall = postAccountRecoverCodeValidateBeforeCall(code, contentType, recoverCompleteBody, null);
        Type localVarReturnType = new TypeToken<AccountActivateResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Complete Account recover (asynchronously)
     * 
     * @param code  (required)
     * @param contentType  (required)
     * @param recoverCompleteBody The size of the body is limited to 2KB. (optional)
     ...
     */
    public okhttp3.Call postAccountRecoverCodeAsync(String code, String contentType, RecoverCompleteBody recoverCompleteBody, final ApiCallback<AccountActivateResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postAccountRecoverCodeValidateBeforeCall(code, contentType, recoverCompleteBody, _callback);
        Type localVarReturnType = new TypeToken<AccountActivateResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
