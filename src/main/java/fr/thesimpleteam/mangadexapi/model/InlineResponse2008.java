...
public class InlineResponse2008 {
  ...
  private List<InlineResponse2008Data> data = null;
  ...
  public InlineResponse2008 result(String result) {
  ...
  **/
  ...
  public InlineResponse2008 response(String response) {
  ...
  **/
  ...
  public InlineResponse2008 data(List<InlineResponse2008Data> data) {
  ...
  public InlineResponse2008 addDataItem(InlineResponse2008Data dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<InlineResponse2008Data>();
    }
  ...
  **/
  ...
  public List<InlineResponse2008Data> getData() {
    return data;
  }


  public void setData(List<InlineResponse2008Data> data) {
    this.data = data;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.result, inlineResponse2008.result) &&
        Objects.equals(this.response, inlineResponse2008.response) &&
