...
public class MappingIdBody {
  ...
  public MappingIdBody type(TypeEnum type) {
  ...
  **/
  ...
  public MappingIdBody ids(List<Integer> ids) {
    
    this.ids = ids;
    return this;
  }

  public MappingIdBody addIdsItem(Integer idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MappingIdBody mappingIdBody = (MappingIdBody) o;
    return Objects.equals(this.type, mappingIdBody.type) &&
        Objects.equals(this.ids, mappingIdBody.ids);
  }
