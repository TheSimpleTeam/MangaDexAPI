...
import fr.thesimpleteam.mangadexapi.model.CustomListCreate;
import fr.thesimpleteam.mangadexapi.model.CustomListEdit;
import fr.thesimpleteam.mangadexapi.model.CustomListList;
import fr.thesimpleteam.mangadexapi.model.CustomListResponse;
...
public class CustomListApi {
    private ApiClient localVarApiClient;

    public CustomListApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CustomListApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call deleteListIdCall(UUID id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/list/{id}"
    ...
    private okhttp3.Call deleteListIdValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteListId(Async)");
        }
        

        okhttp3.Call localVarCall = deleteListIdCall(id, _callback);
        return localVarCall;
     ...
     */
    public Response deleteListId(UUID id) throws ApiException {
        ApiResponse<Response> localVarResp = deleteListIdWithHttpInfo(id);
     ...
     */
    public ApiResponse<Response> deleteListIdWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = deleteListIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete CustomList (asynchronously)
     * 
     * @param id CustomList ID (required)
     ...
     */
    public okhttp3.Call deleteListIdAsync(UUID id, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteListIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteMangaIdListListId
     * @param id Manga ID (required)
     * @param listId CustomList ID (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call deleteMangaIdListListIdCall(UUID id, UUID listId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/manga/{id}/list/{listId}"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteMangaIdListListIdValidateBeforeCall(UUID id, UUID listId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteMangaIdListListId(Async)");
        }
        
        // verify the required parameter 'listId' is set
        if (listId == null) {
            throw new ApiException("Missing the required parameter 'listId' when calling deleteMangaIdListListId(Async)");
        }
        

        okhttp3.Call localVarCall = deleteMangaIdListListIdCall(id, listId, _callback);
        return localVarCall;
     ...
     */
    public Response deleteMangaIdListListId(UUID id, UUID listId) throws ApiException {
        ApiResponse<Response> localVarResp = deleteMangaIdListListIdWithHttpInfo(id, listId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Response> deleteMangaIdListListIdWithHttpInfo(UUID id, UUID listId) throws ApiException {
        okhttp3.Call localVarCall = deleteMangaIdListListIdValidateBeforeCall(id, listId, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Remove Manga in CustomList (asynchronously)
     * 
     * @param id Manga ID (required)
     * @param listId CustomList ID (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call deleteMangaIdListListIdAsync(UUID id, UUID listId, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteMangaIdListListIdValidateBeforeCall(id, listId, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getListId
     * @param id CustomList ID (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> CustomList not found </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getListIdCall(UUID id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getListIdValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getListId(Async)");
        }
        

        okhttp3.Call localVarCall = getListIdCall(id, _callback);
        return localVarCall;
     ...
     */
    public CustomListResponse getListId(UUID id) throws ApiException {
        ApiResponse<CustomListResponse> localVarResp = getListIdWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * 
     * @param id CustomList ID (required)
     * @return ApiResponse&lt;CustomListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CustomListResponse> getListIdWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = getListIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<CustomListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get CustomList (asynchronously)
     * 
     * @param id CustomList ID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getListIdAsync(UUID id, final ApiCallback<CustomListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getListIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<CustomListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getUserIdList
     ...
     */
    public okhttp3.Call getUserIdListCall(UUID id, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/user/{id}/list"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserIdListValidateBeforeCall(UUID id, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getUserIdList(Async)");
        }
        

        okhttp3.Call localVarCall = getUserIdListCall(id, limit, offset, _callback);
        return localVarCall;
     ...
     */
    public CustomListList getUserIdList(UUID id, Integer limit, Integer offset) throws ApiException {
        ApiResponse<CustomListList> localVarResp = getUserIdListWithHttpInfo(id, limit, offset);
        return localVarResp.getData();
    }
     ...
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @return ApiResponse&lt;CustomListList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CustomListList> getUserIdListWithHttpInfo(UUID id, Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getUserIdListValidateBeforeCall(id, limit, offset, null);
        Type localVarReturnType = new TypeToken<CustomListList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get User&#39;s CustomList list (asynchronously)
     * This will list only public CustomList
     * @param id User ID (required)
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     ...
     */
    public okhttp3.Call getUserIdListAsync(UUID id, Integer limit, Integer offset, final ApiCallback<CustomListList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserIdListValidateBeforeCall(id, limit, offset, _callback);
        Type localVarReturnType = new TypeToken<CustomListList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getUserListCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserListValidateBeforeCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getUserListCall(limit, offset, _callback);
        return localVarCall;
     ...
     */
    public CustomListList getUserList(Integer limit, Integer offset) throws ApiException {
        ApiResponse<CustomListList> localVarResp = getUserListWithHttpInfo(limit, offset);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CustomListList> getUserListWithHttpInfo(Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getUserListValidateBeforeCall(limit, offset, null);
        Type localVarReturnType = new TypeToken<CustomListList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get logged User CustomList list (asynchronously)
     * This will list public and private CustomList
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getUserListAsync(Integer limit, Integer offset, final ApiCallback<CustomListList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserListValidateBeforeCall(limit, offset, _callback);
        Type localVarReturnType = new TypeToken<CustomListList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param customListCreate The size of the body is limited to 8KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postListCall(String contentType, CustomListCreate customListCreate, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = customListCreate;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postListValidateBeforeCall(String contentType, CustomListCreate customListCreate, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postListCall(contentType, customListCreate, _callback);
        return localVarCall;
     ...
     */
    public CustomListResponse postList(String contentType, CustomListCreate customListCreate) throws ApiException {
        ApiResponse<CustomListResponse> localVarResp = postListWithHttpInfo(contentType, customListCreate);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CustomListResponse> postListWithHttpInfo(String contentType, CustomListCreate customListCreate) throws ApiException {
        okhttp3.Call localVarCall = postListValidateBeforeCall(contentType, customListCreate, null);
        Type localVarReturnType = new TypeToken<CustomListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create CustomList (asynchronously)
     * 
     * @param contentType  (required)
     * @param customListCreate The size of the body is limited to 8KB. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call postListAsync(String contentType, CustomListCreate customListCreate, final ApiCallback<CustomListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postListValidateBeforeCall(contentType, customListCreate, _callback);
        Type localVarReturnType = new TypeToken<CustomListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postMangaIdListListId
     * @param id Manga ID (required)
     * @param listId CustomList ID (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call postMangaIdListListIdCall(UUID id, UUID listId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postMangaIdListListIdValidateBeforeCall(UUID id, UUID listId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling postMangaIdListListId(Async)");
        }
        
        // verify the required parameter 'listId' is set
        if (listId == null) {
            throw new ApiException("Missing the required parameter 'listId' when calling postMangaIdListListId(Async)");
        }
        

        okhttp3.Call localVarCall = postMangaIdListListIdCall(id, listId, _callback);
        return localVarCall;
     ...
     */
    public Response postMangaIdListListId(UUID id, UUID listId) throws ApiException {
        ApiResponse<Response> localVarResp = postMangaIdListListIdWithHttpInfo(id, listId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Response> postMangaIdListListIdWithHttpInfo(UUID id, UUID listId) throws ApiException {
        okhttp3.Call localVarCall = postMangaIdListListIdValidateBeforeCall(id, listId, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Add Manga in CustomList (asynchronously)
     * 
     * @param id Manga ID (required)
     * @param listId CustomList ID (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call postMangaIdListListIdAsync(UUID id, UUID listId, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = postMangaIdListListIdValidateBeforeCall(id, listId, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for putListId
     * @param id CustomList ID (required)
     * @param contentType  (required)
     * @param customListEdit  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call putListIdCall(UUID id, String contentType, CustomListEdit customListEdit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = customListEdit;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putListIdValidateBeforeCall(UUID id, String contentType, CustomListEdit customListEdit, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling putListId(Async)");
        }
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling putListId(Async)");
        }
        

        okhttp3.Call localVarCall = putListIdCall(id, contentType, customListEdit, _callback);
        return localVarCall;
     ...
     */
    public CustomListResponse putListId(UUID id, String contentType, CustomListEdit customListEdit) throws ApiException {
        ApiResponse<CustomListResponse> localVarResp = putListIdWithHttpInfo(id, contentType, customListEdit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CustomListResponse> putListIdWithHttpInfo(UUID id, String contentType, CustomListEdit customListEdit) throws ApiException {
        okhttp3.Call localVarCall = putListIdValidateBeforeCall(id, contentType, customListEdit, null);
        Type localVarReturnType = new TypeToken<CustomListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update CustomList (asynchronously)
     * The size of the body is limited to 8KB.
     * @param id CustomList ID (required)
     * @param contentType  (required)
     * @param customListEdit  (optional)
     ...
     */
    public okhttp3.Call putListIdAsync(UUID id, String contentType, CustomListEdit customListEdit, final ApiCallback<CustomListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = putListIdValidateBeforeCall(id, contentType, customListEdit, _callback);
        Type localVarReturnType = new TypeToken<CustomListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
