...
import fr.thesimpleteam.mangadexapi.model.AuthorCreate;
import fr.thesimpleteam.mangadexapi.model.AuthorEdit;
import fr.thesimpleteam.mangadexapi.model.AuthorList;
import fr.thesimpleteam.mangadexapi.model.AuthorResponse;
import fr.thesimpleteam.mangadexapi.model.Order6;
...
public class AuthorApi {
     ...
     */
    public okhttp3.Call deleteAuthorIdCall(UUID id, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteAuthorIdValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteAuthorId(Async)");
        }
        

        okhttp3.Call localVarCall = deleteAuthorIdCall(id, _callback);
        return localVarCall;
     ...
     */
    public Response deleteAuthorId(UUID id) throws ApiException {
        ApiResponse<Response> localVarResp = deleteAuthorIdWithHttpInfo(id);
     ...
     */
    public ApiResponse<Response> deleteAuthorIdWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = deleteAuthorIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete Author (asynchronously)
     * 
     * @param id Author ID (required)
     ...
     */
    public okhttp3.Call deleteAuthorIdAsync(UUID id, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAuthorIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
     ...
     * @param ids Author ids (limited to 100 per request) (optional)
     * @param name  (optional)
     ...
     */
    public okhttp3.Call getAuthorCall(Integer limit, Integer offset, List<UUID> ids, String name, Order6 order, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAuthorValidateBeforeCall(Integer limit, Integer offset, List<UUID> ids, String name, Order6 order, List<String> includes, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAuthorCall(limit, offset, ids, name, order, includes, _callback);
        return localVarCall;
     ...
     */
    public AuthorList getAuthor(Integer limit, Integer offset, List<UUID> ids, String name, Order6 order, List<String> includes) throws ApiException {
        ApiResponse<AuthorList> localVarResp = getAuthorWithHttpInfo(limit, offset, ids, name, order, includes);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AuthorList> getAuthorWithHttpInfo(Integer limit, Integer offset, List<UUID> ids, String name, Order6 order, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getAuthorValidateBeforeCall(limit, offset, ids, name, order, includes, null);
        Type localVarReturnType = new TypeToken<AuthorList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Author list (asynchronously)
     * 
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param ids Author ids (limited to 100 per request) (optional)
     ...
     */
    public okhttp3.Call getAuthorAsync(Integer limit, Integer offset, List<UUID> ids, String name, Order6 order, List<String> includes, final ApiCallback<AuthorList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAuthorValidateBeforeCall(limit, offset, ids, name, order, includes, _callback);
        Type localVarReturnType = new TypeToken<AuthorList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAuthorId
     * @param id Author ID (required)
     * @param includes  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Author no content </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAuthorIdCall(UUID id, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAuthorIdValidateBeforeCall(UUID id, List<String> includes, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getAuthorId(Async)");
        }
        

        okhttp3.Call localVarCall = getAuthorIdCall(id, includes, _callback);
        return localVarCall;
     ...
     */
    public AuthorResponse getAuthorId(UUID id, List<String> includes) throws ApiException {
        ApiResponse<AuthorResponse> localVarResp = getAuthorIdWithHttpInfo(id, includes);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AuthorResponse> getAuthorIdWithHttpInfo(UUID id, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getAuthorIdValidateBeforeCall(id, includes, null);
        Type localVarReturnType = new TypeToken<AuthorResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Author (asynchronously)
     * 
     * @param id Author ID (required)
     * @param includes  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getAuthorIdAsync(UUID id, List<String> includes, final ApiCallback<AuthorResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAuthorIdValidateBeforeCall(id, includes, _callback);
        Type localVarReturnType = new TypeToken<AuthorResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postAuthor
     * @param contentType  (required)
     * @param authorCreate The size of the body is limited to 2KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postAuthorCall(String contentType, AuthorCreate authorCreate, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = authorCreate;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postAuthorValidateBeforeCall(String contentType, AuthorCreate authorCreate, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling postAuthor(Async)");
        }
        

        okhttp3.Call localVarCall = postAuthorCall(contentType, authorCreate, _callback);
        return localVarCall;
     ...
     */
    public AuthorResponse postAuthor(String contentType, AuthorCreate authorCreate) throws ApiException {
        ApiResponse<AuthorResponse> localVarResp = postAuthorWithHttpInfo(contentType, authorCreate);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AuthorResponse> postAuthorWithHttpInfo(String contentType, AuthorCreate authorCreate) throws ApiException {
        okhttp3.Call localVarCall = postAuthorValidateBeforeCall(contentType, authorCreate, null);
        Type localVarReturnType = new TypeToken<AuthorResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postAuthorAsync(String contentType, AuthorCreate authorCreate, final ApiCallback<AuthorResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postAuthorValidateBeforeCall(contentType, authorCreate, _callback);
        Type localVarReturnType = new TypeToken<AuthorResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for putAuthorId
     * @param id Author ID (required)
     * @param contentType  (required)
     * @param authorEdit The size of the body is limited to 2KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call putAuthorIdCall(UUID id, String contentType, AuthorEdit authorEdit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = authorEdit;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putAuthorIdValidateBeforeCall(UUID id, String contentType, AuthorEdit authorEdit, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling putAuthorId(Async)");
        }
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling putAuthorId(Async)");
        }
        

        okhttp3.Call localVarCall = putAuthorIdCall(id, contentType, authorEdit, _callback);
        return localVarCall;
     ...
     */
    public AuthorResponse putAuthorId(UUID id, String contentType, AuthorEdit authorEdit) throws ApiException {
        ApiResponse<AuthorResponse> localVarResp = putAuthorIdWithHttpInfo(id, contentType, authorEdit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AuthorResponse> putAuthorIdWithHttpInfo(UUID id, String contentType, AuthorEdit authorEdit) throws ApiException {
        okhttp3.Call localVarCall = putAuthorIdValidateBeforeCall(id, contentType, authorEdit, null);
        Type localVarReturnType = new TypeToken<AuthorResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call putAuthorIdAsync(UUID id, String contentType, AuthorEdit authorEdit, final ApiCallback<AuthorResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = putAuthorIdValidateBeforeCall(id, contentType, authorEdit, _callback);
        Type localVarReturnType = new TypeToken<AuthorResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
