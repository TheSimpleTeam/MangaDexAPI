...
public class CustomListEdit {
  ...
  public CustomListEdit name(String name) {
  ...
  **/
  ...
  public CustomListEdit visibility(VisibilityEnum visibility) {
  ...
  **/
  ...
  public CustomListEdit manga(List<UUID> manga) {
    
    this.manga = manga;
    return this;
  }

  public CustomListEdit addMangaItem(UUID mangaItem) {
    if (this.manga == null) {
  ...
  **/
  ...
  public CustomListEdit version(Integer version) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomListEdit customListEdit = (CustomListEdit) o;
    return Objects.equals(this.name, customListEdit.name) &&
        Objects.equals(this.visibility, customListEdit.visibility) &&
        Objects.equals(this.manga, customListEdit.manga) &&
        Objects.equals(this.version, customListEdit.version);
  }
