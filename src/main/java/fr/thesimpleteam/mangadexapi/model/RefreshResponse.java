...
public class RefreshResponse {
  ...
  private LoginResponseToken token;
  ...
  public RefreshResponse result(ResultEnum result) {
  ...
  **/
  ...
  public RefreshResponse token(LoginResponseToken token) {
  ...
  **/
  ...
  public LoginResponseToken getToken() {
    return token;
  }


  public void setToken(LoginResponseToken token) {
    this.token = token;
  }


  public RefreshResponse message(String message) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.result, refreshResponse.result) &&
        Objects.equals(this.token, refreshResponse.token) &&
        Objects.equals(this.message, refreshResponse.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(result, token, message);
  }
