...
public class CustomListResponse {
  ...
  public CustomListResponse result(ResultEnum result) {
  ...
  **/
  ...
  public CustomListResponse response(String response) {
  ...
  **/
  ...
  public CustomListResponse data(CustomList data) {
  ...
  **/
  ...
  public void setData(CustomList data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CustomListResponse customListResponse = (CustomListResponse) o;
    return Objects.equals(this.result, customListResponse.result) &&
        Objects.equals(this.response, customListResponse.response) &&
        Objects.equals(this.data, customListResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomListResponse {\n");
