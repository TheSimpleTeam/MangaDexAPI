...
public class Order {
   ...
   * Gets or Sets year
   */
  @JsonAdapter(YearEnum.Adapter.class)
  public enum YearEnum {
    ...
    public static YearEnum fromValue(String value) {
      for (YearEnum b : YearEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<YearEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final YearEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public YearEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return YearEnum.fromValue(value);
      }
    }
  }
   ...
   */
  @JsonAdapter(LatestUploadedChapterEnum.Adapter.class)
  public enum LatestUploadedChapterEnum {
    ...
    LatestUploadedChapterEnum(String value) {
      this.value = value;
    }
    ...
    public static LatestUploadedChapterEnum fromValue(String value) {
      for (LatestUploadedChapterEnum b : LatestUploadedChapterEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<LatestUploadedChapterEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final LatestUploadedChapterEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public LatestUploadedChapterEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return LatestUploadedChapterEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_LATEST_UPLOADED_CHAPTER = "latestUploadedChapter";
  @SerializedName(SERIALIZED_NAME_LATEST_UPLOADED_CHAPTER)
  private LatestUploadedChapterEnum latestUploadedChapter;

  /**
   * Gets or Sets followedCount
   */
  @JsonAdapter(FollowedCountEnum.Adapter.class)
  public enum FollowedCountEnum {
    ...
    FollowedCountEnum(String value) {
      this.value = value;
    }
    ...
    public static FollowedCountEnum fromValue(String value) {
      for (FollowedCountEnum b : FollowedCountEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<FollowedCountEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final FollowedCountEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public FollowedCountEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return FollowedCountEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_FOLLOWED_COUNT = "followedCount";
  @SerializedName(SERIALIZED_NAME_FOLLOWED_COUNT)
  private FollowedCountEnum followedCount;
  ...
  public Order title(TitleEnum title) {
  ...
  **/
  ...
  public Order year(YearEnum year) {
  ...
  **/
  ...
  public Order createdAt(CreatedAtEnum createdAt) {
  ...
  **/
  ...
  public Order updatedAt(UpdatedAtEnum updatedAt) {
  ...
  **/
  ...
  public Order latestUploadedChapter(LatestUploadedChapterEnum latestUploadedChapter) {
  ...
  **/
  ...
  public LatestUploadedChapterEnum getLatestUploadedChapter() {
    return latestUploadedChapter;
  }


  public void setLatestUploadedChapter(LatestUploadedChapterEnum latestUploadedChapter) {
    this.latestUploadedChapter = latestUploadedChapter;
  }


  public Order followedCount(FollowedCountEnum followedCount) {
  ...
  **/
  ...
  public FollowedCountEnum getFollowedCount() {
    return followedCount;
  }


  public void setFollowedCount(FollowedCountEnum followedCount) {
    this.followedCount = followedCount;
  }


  public Order relevance(RelevanceEnum relevance) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Order order = (Order) o;
    return Objects.equals(this.title, order.title) &&
        Objects.equals(this.year, order.year) &&
        Objects.equals(this.createdAt, order.createdAt) &&
        Objects.equals(this.updatedAt, order.updatedAt) &&
        Objects.equals(this.latestUploadedChapter, order.latestUploadedChapter) &&
        Objects.equals(this.followedCount, order.followedCount) &&
        Objects.equals(this.relevance, order.relevance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, year, createdAt, updatedAt, latestUploadedChapter, followedCount, relevance);
  }
  ...
  public String toString() {
    ...
    sb.append("    latestUploadedChapter: ").append(toIndentedString(latestUploadedChapter)).append("\n");
    sb.append("    followedCount: ").append(toIndentedString(followedCount)).append("\n");
