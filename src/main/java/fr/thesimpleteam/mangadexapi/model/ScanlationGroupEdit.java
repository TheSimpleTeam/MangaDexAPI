...
public class ScanlationGroupEdit {
  ...
  private List<UUID> members = null;
  ...
  public static final String SERIALIZED_NAME_FOCUSED_LANGUAGES = "focusedLanguages";
  @SerializedName(SERIALIZED_NAME_FOCUSED_LANGUAGES)
  private List<String> focusedLanguages = null;
  ...
  public ScanlationGroupEdit name(String name) {
  ...
  **/
  ...
  public ScanlationGroupEdit leader(UUID leader) {
  ...
  **/
  ...
  public ScanlationGroupEdit members(List<UUID> members) {
    
    this.members = members;
    return this;
  }

  public ScanlationGroupEdit addMembersItem(UUID membersItem) {
  ...
  **/
  ...
  public ScanlationGroupEdit website(String website) {
  ...
  **/
  ...
  public ScanlationGroupEdit ircServer(String ircServer) {
  ...
  **/
  ...
  public ScanlationGroupEdit ircChannel(String ircChannel) {
  ...
  **/
  ...
  public ScanlationGroupEdit discord(String discord) {
  ...
  **/
  ...
  public ScanlationGroupEdit contactEmail(String contactEmail) {
  ...
  **/
  ...
  public ScanlationGroupEdit description(String description) {
  ...
  **/
  ...
  public ScanlationGroupEdit twitter(URI twitter) {
  ...
  **/
  ...
  public ScanlationGroupEdit focusedLanguages(List<String> focusedLanguages) {
    
    this.focusedLanguages = focusedLanguages;
    return this;
  }

  public ScanlationGroupEdit addFocusedLanguagesItem(String focusedLanguagesItem) {
    if (this.focusedLanguages == null) {
      this.focusedLanguages = new ArrayList<String>();
    }
    this.focusedLanguages.add(focusedLanguagesItem);
    return this;
  }

   /**
   * Get focusedLanguages
   * @return focusedLanguages
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public List<String> getFocusedLanguages() {
    return focusedLanguages;
  }


  public void setFocusedLanguages(List<String> focusedLanguages) {
    this.focusedLanguages = focusedLanguages;
  }


  public ScanlationGroupEdit locked(Boolean locked) {
  ...
  **/
  ...
  public ScanlationGroupEdit version(Integer version) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ScanlationGroupEdit scanlationGroupEdit = (ScanlationGroupEdit) o;
    return Objects.equals(this.name, scanlationGroupEdit.name) &&
        Objects.equals(this.leader, scanlationGroupEdit.leader) &&
        Objects.equals(this.members, scanlationGroupEdit.members) &&
        Objects.equals(this.website, scanlationGroupEdit.website) &&
        Objects.equals(this.ircServer, scanlationGroupEdit.ircServer) &&
        Objects.equals(this.ircChannel, scanlationGroupEdit.ircChannel) &&
        Objects.equals(this.discord, scanlationGroupEdit.discord) &&
        Objects.equals(this.contactEmail, scanlationGroupEdit.contactEmail) &&
        Objects.equals(this.description, scanlationGroupEdit.description) &&
        Objects.equals(this.twitter, scanlationGroupEdit.twitter) &&
        Objects.equals(this.focusedLanguages, scanlationGroupEdit.focusedLanguages) &&
        Objects.equals(this.locked, scanlationGroupEdit.locked) &&
        Objects.equals(this.version, scanlationGroupEdit.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, leader, members, website, ircServer, ircChannel, discord, contactEmail, description, twitter, focusedLanguages, locked, version);
  }
  ...
  public String toString() {
    ...
    sb.append("    focusedLanguages: ").append(toIndentedString(focusedLanguages)).append("\n");
