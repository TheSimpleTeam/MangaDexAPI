...
import fr.thesimpleteam.mangadexapi.model.ChapterEdit;
import fr.thesimpleteam.mangadexapi.model.ChapterList;
import fr.thesimpleteam.mangadexapi.model.ChapterResponse;
import org.openapitools.client.model.OneOfstringarray;
import fr.thesimpleteam.mangadexapi.model.Order2;
...
public class ChapterApi {
    ...
    /**
     * Build call for deleteChapterId
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Chapter has been deleted. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteChapterIdCall(UUID id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/chapter/{id}"
    ...
    private okhttp3.Call deleteChapterIdValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteChapterId(Async)");
        }
        

        okhttp3.Call localVarCall = deleteChapterIdCall(id, _callback);
        return localVarCall;
     ...
     */
    public Response deleteChapterId(UUID id) throws ApiException {
        ApiResponse<Response> localVarResp = deleteChapterIdWithHttpInfo(id);
     ...
     */
    public ApiResponse<Response> deleteChapterIdWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = deleteChapterIdValidateBeforeCall(id, null);
     ...
     */
    public okhttp3.Call deleteChapterIdAsync(UUID id, final ApiCallback<Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteChapterIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
     ...
     * @param ids Chapter ids (limited to 100 per request) (optional)
     * @param title  (optional)
     * @param groups  (optional)
     * @param uploader  (optional)
     * @param manga  (optional)
     * @param volume  (optional, default to null)
     * @param chapter  (optional, default to null)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Chapter list </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getChapterCall(Integer limit, Integer offset, List<UUID> ids, String title, List<UUID> groups, UUID uploader, UUID manga, OneOfstringarray volume, OneOfstringarray chapter, List<String> translatedLanguage, List<String> originalLanguage, List<String> excludedOriginalLanguage, List<String> contentRating, String includeFutureUpdates, String createdAtSince, String updatedAtSince, String publishAtSince, Order2 order, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/chapter";
        ...
        if (uploader != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("uploader", uploader));
        }

        if (manga != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("manga", manga));
        }
        ...
        if (chapter != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("chapter", chapter));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getChapterValidateBeforeCall(Integer limit, Integer offset, List<UUID> ids, String title, List<UUID> groups, UUID uploader, UUID manga, OneOfstringarray volume, OneOfstringarray chapter, List<String> translatedLanguage, List<String> originalLanguage, List<String> excludedOriginalLanguage, List<String> contentRating, String includeFutureUpdates, String createdAtSince, String updatedAtSince, String publishAtSince, Order2 order, List<String> includes, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getChapterCall(limit, offset, ids, title, groups, uploader, manga, volume, chapter, translatedLanguage, originalLanguage, excludedOriginalLanguage, contentRating, includeFutureUpdates, createdAtSince, updatedAtSince, publishAtSince, order, includes, _callback);
        return localVarCall;
     ...
     */
    public ChapterList getChapter(Integer limit, Integer offset, List<UUID> ids, String title, List<UUID> groups, UUID uploader, UUID manga, OneOfstringarray volume, OneOfstringarray chapter, List<String> translatedLanguage, List<String> originalLanguage, List<String> excludedOriginalLanguage, List<String> contentRating, String includeFutureUpdates, String createdAtSince, String updatedAtSince, String publishAtSince, Order2 order, List<String> includes) throws ApiException {
        ApiResponse<ChapterList> localVarResp = getChapterWithHttpInfo(limit, offset, ids, title, groups, uploader, manga, volume, chapter, translatedLanguage, originalLanguage, excludedOriginalLanguage, contentRating, includeFutureUpdates, createdAtSince, updatedAtSince, publishAtSince, order, includes);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChapterList> getChapterWithHttpInfo(Integer limit, Integer offset, List<UUID> ids, String title, List<UUID> groups, UUID uploader, UUID manga, OneOfstringarray volume, OneOfstringarray chapter, List<String> translatedLanguage, List<String> originalLanguage, List<String> excludedOriginalLanguage, List<String> contentRating, String includeFutureUpdates, String createdAtSince, String updatedAtSince, String publishAtSince, Order2 order, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getChapterValidateBeforeCall(limit, offset, ids, title, groups, uploader, manga, volume, chapter, translatedLanguage, originalLanguage, excludedOriginalLanguage, contentRating, includeFutureUpdates, createdAtSince, updatedAtSince, publishAtSince, order, includes, null);
        Type localVarReturnType = new TypeToken<ChapterList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Chapter list (asynchronously)
     * Chapter list. If you want the Chapters of a given Manga, please check the feed endpoints.
     * @param limit  (optional, default to 10)
     * @param offset  (optional)
     * @param ids Chapter ids (limited to 100 per request) (optional)
     ...
     */
    public okhttp3.Call getChapterAsync(Integer limit, Integer offset, List<UUID> ids, String title, List<UUID> groups, UUID uploader, UUID manga, OneOfstringarray volume, OneOfstringarray chapter, List<String> translatedLanguage, List<String> originalLanguage, List<String> excludedOriginalLanguage, List<String> contentRating, String includeFutureUpdates, String createdAtSince, String updatedAtSince, String publishAtSince, Order2 order, List<String> includes, final ApiCallback<ChapterList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getChapterValidateBeforeCall(limit, offset, ids, title, groups, uploader, manga, volume, chapter, translatedLanguage, originalLanguage, excludedOriginalLanguage, contentRating, includeFutureUpdates, createdAtSince, updatedAtSince, publishAtSince, order, includes, _callback);
        Type localVarReturnType = new TypeToken<ChapterList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getChapterId
     * @param id Chapter ID (required)
     * @param includes  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call getChapterIdCall(UUID id, List<String> includes, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getChapterIdValidateBeforeCall(UUID id, List<String> includes, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getChapterId(Async)");
        }
        

        okhttp3.Call localVarCall = getChapterIdCall(id, includes, _callback);
        return localVarCall;
     ...
     */
    public ChapterResponse getChapterId(UUID id, List<String> includes) throws ApiException {
        ApiResponse<ChapterResponse> localVarResp = getChapterIdWithHttpInfo(id, includes);
        return localVarResp.getData();
    }
     ...
     * @param id Chapter ID (required)
     * @param includes  (optional)
     * @return ApiResponse&lt;ChapterResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ChapterResponse> getChapterIdWithHttpInfo(UUID id, List<String> includes) throws ApiException {
        okhttp3.Call localVarCall = getChapterIdValidateBeforeCall(id, includes, null);
        Type localVarReturnType = new TypeToken<ChapterResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Chapter (asynchronously)
     * 
     * @param id Chapter ID (required)
     * @param includes  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getChapterIdAsync(UUID id, List<String> includes, final ApiCallback<ChapterResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getChapterIdValidateBeforeCall(id, includes, _callback);
        Type localVarReturnType = new TypeToken<ChapterResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for putChapterId
     * @param id Chapter ID (required)
     * @param contentType  (required)
     * @param chapterEdit The size of the body is limited to 32KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call putChapterIdCall(UUID id, String contentType, ChapterEdit chapterEdit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = chapterEdit;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putChapterIdValidateBeforeCall(UUID id, String contentType, ChapterEdit chapterEdit, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling putChapterId(Async)");
        }
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling putChapterId(Async)");
        }
        

        okhttp3.Call localVarCall = putChapterIdCall(id, contentType, chapterEdit, _callback);
        return localVarCall;
     ...
     */
    public ChapterResponse putChapterId(UUID id, String contentType, ChapterEdit chapterEdit) throws ApiException {
        ApiResponse<ChapterResponse> localVarResp = putChapterIdWithHttpInfo(id, contentType, chapterEdit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChapterResponse> putChapterIdWithHttpInfo(UUID id, String contentType, ChapterEdit chapterEdit) throws ApiException {
        okhttp3.Call localVarCall = putChapterIdValidateBeforeCall(id, contentType, chapterEdit, null);
        Type localVarReturnType = new TypeToken<ChapterResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update Chapter (asynchronously)
     * 
     * @param id Chapter ID (required)
     * @param contentType  (required)
     * @param chapterEdit The size of the body is limited to 32KB. (optional)
     ...
     */
    public okhttp3.Call putChapterIdAsync(UUID id, String contentType, ChapterEdit chapterEdit, final ApiCallback<ChapterResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = putChapterIdValidateBeforeCall(id, contentType, chapterEdit, _callback);
        Type localVarReturnType = new TypeToken<ChapterResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
