...
import fr.thesimpleteam.mangadexapi.model.CheckResponse;
import fr.thesimpleteam.mangadexapi.model.Login;
import fr.thesimpleteam.mangadexapi.model.LoginResponse;
import fr.thesimpleteam.mangadexapi.model.LogoutResponse;
import fr.thesimpleteam.mangadexapi.model.RefreshResponse;
import fr.thesimpleteam.mangadexapi.model.RefreshToken;
...
public class AuthApi {
     ...
     */
    public okhttp3.Call getAuthCheckCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/auth/check";
    ...
    private okhttp3.Call getAuthCheckValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAuthCheckCall(_callback);
        return localVarCall;
     ...
     */
    public CheckResponse getAuthCheck() throws ApiException {
        ApiResponse<CheckResponse> localVarResp = getAuthCheckWithHttpInfo();
     ...
     */
    public ApiResponse<CheckResponse> getAuthCheckWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAuthCheckValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getAuthCheckAsync(final ApiCallback<CheckResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAuthCheckValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<CheckResponse>(){}.getType();
     ...
     * @param login The size of the body is limited to 2KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postAuthLoginCall(String contentType, Login login, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postAuthLoginValidateBeforeCall(String contentType, Login login, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling postAuthLogin(Async)");
        }
        

        okhttp3.Call localVarCall = postAuthLoginCall(contentType, login, _callback);
        return localVarCall;
     ...
     */
    public LoginResponse postAuthLogin(String contentType, Login login) throws ApiException {
        ApiResponse<LoginResponse> localVarResp = postAuthLoginWithHttpInfo(contentType, login);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<LoginResponse> postAuthLoginWithHttpInfo(String contentType, Login login) throws ApiException {
        okhttp3.Call localVarCall = postAuthLoginValidateBeforeCall(contentType, login, null);
     ...
     */
    public okhttp3.Call postAuthLoginAsync(String contentType, Login login, final ApiCallback<LoginResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postAuthLoginValidateBeforeCall(contentType, login, _callback);
        Type localVarReturnType = new TypeToken<LoginResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call postAuthLogoutValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postAuthLogoutCall(_callback);
        return localVarCall;
     ...
     */
    public LogoutResponse postAuthLogout() throws ApiException {
        ApiResponse<LogoutResponse> localVarResp = postAuthLogoutWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<LogoutResponse> postAuthLogoutWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call postAuthLogoutAsync(final ApiCallback<LogoutResponse> _callback) throws ApiException {
     ...
     * @param contentType  (required)
     * @param refreshToken The size of the body is limited to 2KB. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postAuthRefreshCall(String contentType, RefreshToken refreshToken, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postAuthRefreshValidateBeforeCall(String contentType, RefreshToken refreshToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling postAuthRefresh(Async)");
        }
        

        okhttp3.Call localVarCall = postAuthRefreshCall(contentType, refreshToken, _callback);
        return localVarCall;
     ...
     */
    public RefreshResponse postAuthRefresh(String contentType, RefreshToken refreshToken) throws ApiException {
        ApiResponse<RefreshResponse> localVarResp = postAuthRefreshWithHttpInfo(contentType, refreshToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<RefreshResponse> postAuthRefreshWithHttpInfo(String contentType, RefreshToken refreshToken) throws ApiException {
        okhttp3.Call localVarCall = postAuthRefreshValidateBeforeCall(contentType, refreshToken, null);
     ...
     */
    public okhttp3.Call postAuthRefreshAsync(String contentType, RefreshToken refreshToken, final ApiCallback<RefreshResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postAuthRefreshValidateBeforeCall(contentType, refreshToken, _callback);
        Type localVarReturnType = new TypeToken<RefreshResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
