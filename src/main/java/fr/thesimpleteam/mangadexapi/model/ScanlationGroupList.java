...
public class ScanlationGroupList {
  ...
  private String response = "collection";

  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ScanlationGroup> data = null;
  ...
  public ScanlationGroupList result(String result) {
  ...
  **/
  ...
  public ScanlationGroupList response(String response) {
  ...
  **/
  ...
  public ScanlationGroupList data(List<ScanlationGroup> data) {
    
    this.data = data;
    return this;
  }

  public ScanlationGroupList addDataItem(ScanlationGroup dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<ScanlationGroup>();
    }
  ...
  **/
  ...
  public List<ScanlationGroup> getData() {
    return data;
  }


  public void setData(List<ScanlationGroup> data) {
    this.data = data;
  }


  public ScanlationGroupList limit(Integer limit) {
  ...
  **/
  ...
  public ScanlationGroupList offset(Integer offset) {
  ...
  **/
  ...
  public ScanlationGroupList total(Integer total) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ScanlationGroupList scanlationGroupList = (ScanlationGroupList) o;
    return Objects.equals(this.result, scanlationGroupList.result) &&
        Objects.equals(this.response, scanlationGroupList.response) &&
        Objects.equals(this.data, scanlationGroupList.data) &&
        Objects.equals(this.limit, scanlationGroupList.limit) &&
        Objects.equals(this.offset, scanlationGroupList.offset) &&
        Objects.equals(this.total, scanlationGroupList.total);
  }

  @Override
  public int hashCode() {
    return Objects.hash(result, response, data, limit, offset, total);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScanlationGroupList {\n");
