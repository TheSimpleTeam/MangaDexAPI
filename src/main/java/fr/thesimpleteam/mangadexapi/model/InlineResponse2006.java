...
public class InlineResponse2006 {
  ...
  private Map<String, InnerEnum> statuses = null;
  ...
  **/
  ...
  public InlineResponse2006 statuses(Map<String, InnerEnum> statuses) {
    
    this.statuses = statuses;
    return this;
  }

  public InlineResponse2006 putStatusesItem(String key, InnerEnum statusesItem) {
    if (this.statuses == null) {
      this.statuses = new HashMap<String, InnerEnum>();
    }
  ...
  **/
  ...
  public Map<String, InnerEnum> getStatuses() {
    return statuses;
  }


  public void setStatuses(Map<String, InnerEnum> statuses) {
    this.statuses = statuses;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.result, inlineResponse2006.result) &&
        Objects.equals(this.statuses, inlineResponse2006.statuses);
  }

  @Override
  public int hashCode() {
    return Objects.hash(result, statuses);
  }
