...
public class CustomListList {
  ...
  private List<CustomList> data = null;
  ...
  public CustomListList result(String result) {
  ...
  **/
  ...
  public CustomListList response(String response) {
  ...
  **/
  ...
  public CustomListList data(List<CustomList> data) {
    
    this.data = data;
    return this;
  }

  public CustomListList addDataItem(CustomList dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<CustomList>();
    }
  ...
  **/
  ...
  public CustomListList limit(Integer limit) {
  ...
  **/
  ...
  public CustomListList offset(Integer offset) {
  ...
  **/
  ...
  public CustomListList total(Integer total) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomListList customListList = (CustomListList) o;
    return Objects.equals(this.result, customListList.result) &&
        Objects.equals(this.response, customListList.response) &&
        Objects.equals(this.data, customListList.data) &&
        Objects.equals(this.limit, customListList.limit) &&
        Objects.equals(this.offset, customListList.offset) &&
        Objects.equals(this.total, customListList.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomListList {\n");
