...
public class MangaRelationResponse {
  /**
   * Gets or Sets result
   */
  ...
  private String response = "entity";

  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private MangaRelation data;


  public MangaRelationResponse result(ResultEnum result) {
  ...
  **/
  ...
  public MangaRelationResponse response(String response) {
  ...
  **/
  ...
  public MangaRelationResponse data(MangaRelation data) {
  ...
  **/
  ...
  public MangaRelation getData() {
    return data;
  }


  public void setData(MangaRelation data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    MangaRelationResponse mangaRelationResponse = (MangaRelationResponse) o;
    return Objects.equals(this.result, mangaRelationResponse.result) &&
        Objects.equals(this.response, mangaRelationResponse.response) &&
        Objects.equals(this.data, mangaRelationResponse.data);
  }

  @Override
  public int hashCode() {
    return Objects.hash(result, response, data);
  }
  ...
  public String toString() {
    ...
    sb.append("class MangaRelationResponse {\n");
