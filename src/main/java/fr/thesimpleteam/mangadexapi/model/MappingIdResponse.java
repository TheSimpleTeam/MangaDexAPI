...
public class MappingIdResponse {
  ...
  private List<MappingId> data = null;
  ...
  public MappingIdResponse result(String result) {
  ...
  **/
  ...
  public MappingIdResponse response(String response) {
  ...
  **/
  ...
  public MappingIdResponse data(List<MappingId> data) {
    
    this.data = data;
    return this;
  }

  public MappingIdResponse addDataItem(MappingId dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<MappingId>();
    }
  ...
  **/
  ...
  public List<MappingId> getData() {
    return data;
  }


  public void setData(List<MappingId> data) {
    this.data = data;
  }


  public MappingIdResponse limit(Integer limit) {
  ...
  **/
  ...
  public MappingIdResponse offset(Integer offset) {
  ...
  **/
  ...
  public MappingIdResponse total(Integer total) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MappingIdResponse mappingIdResponse = (MappingIdResponse) o;
    return Objects.equals(this.result, mappingIdResponse.result) &&
        Objects.equals(this.response, mappingIdResponse.response) &&
        Objects.equals(this.data, mappingIdResponse.data) &&
        Objects.equals(this.limit, mappingIdResponse.limit) &&
        Objects.equals(this.offset, mappingIdResponse.offset) &&
        Objects.equals(this.total, mappingIdResponse.total);
  }
