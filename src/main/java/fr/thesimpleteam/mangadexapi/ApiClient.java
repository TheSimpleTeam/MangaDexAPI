...
import fr.thesimpleteam.mangadexapi.auth.ApiKeyAuth;
import fr.thesimpleteam.mangadexapi.auth.Authentication;
import fr.thesimpleteam.mangadexapi.auth.HttpBasicAuth;
import fr.thesimpleteam.mangadexapi.auth.HttpBearerAuth;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "https://api.mangadex.org";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/5.3.12/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.mangadex.org
